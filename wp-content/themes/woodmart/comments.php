...
<div id="comments" class="comments-area">
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( wp_kses( _nx( 'phản hồi của khách hàng về &ldquo;%2$s&rdquo;', '%1$s phản hồi của khách hàng về &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'woodmart' ), array() ),
					number_format_i18n( get_comments_number() ), '<a href="'.get_current_url().'">'.get_the_title().'</a>');
			?>
		</h2>
